        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    //MARK: - Action Sheet
                    HStack {
                        CustomV(title: buttonTitlesArr[0], isClicked: $isSheetClicked, dynamicTitle: .constant(""))
                           
                        //MARK: - Action Alert
                        CustomV(title: buttonTitlesArr[1], isClicked: $isAlertClicked, dynamicTitle: .constant(""))
                        ...
                        //MARK: - Pop over
                        CustomV(title: buttonTitlesArr[2], isClicked: $isPopoverClicked, dynamicTitle: .constant(""))
                    ...
                    //MARK: - Color Picker
                    HStack {
                        CustomV(title: buttonTitlesArr[3], isClicked: $isColorPickerClicked, dynamicTitle: .constant(""))
                        ...
                        CustomV(title: pickedColor, isClicked: $isPickerClicked, dynamicTitle: $pickedColor)
                    ...
                    HStack {
                        ...
                        CustomV(title: buttonTitlesArr[6], isClicked: $isToggleClicked, dynamicTitle: .constant(""))
                    ...
                    //MARK: - Date Picker
                    CustomV(title: buttonTitlesArr[7], isClicked: $isDatePickerClicked, dynamicTitle: .constant(""))
                    ...
                    //MARK: - Stepper
                    CustomV(title: buttonTitlesArr[8], isClicked: $isStepperClicked, dynamicTitle: .constant(""))
